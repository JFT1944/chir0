...
let staffInfo = {
  sam: {
    ...
    bio: [`After earning his bachelor's degree in Biology from the University of North Carolina at  Greensboro in Greensboro, North Carolina, Dr. Sam Kashani went on to complete his  Doctor of Chiropractic from Life University in Marietta, Georgia in 2001. Dedicated to  educating and serving his community, Dr. Sam is committed to helping each of his pa tients discover their full potential with the knowledge he has gained over the years.`, `Now co-owners of Pro Healthcare with Dr. Dante Gurgigno, they are dedicated to help ing individuals with their healthcare needs.`, `Dr. Sam, his wife and two children currently lives in the Woodstock, Georgia. Dr. Sam  is very active in his community and surrounding areas.`, `His favorite quote is from B.J. Palmer: “The power that made the body will heal the  body.`],
    photo: img,
  },
  dante: {
    name: "Dante Gurgigno, DC",
    position: "Chiropractor, Rehab Therapist",
    bio: [`Dr. Dante Gurgigno actively takes time to listen to his patients and treat them in accordance with  their unique needs because he believes in fostering a healthy and positive lifestyle. Since earning  his degree from Life University in June, 2000, he has made a significant contribution to the  healthcare industry. He has traveled the nation throughout the years while continuing his studies to  be up to date on new techniques and methods. During that time, he was introduced to the integrated medical approach that still guides his practice today. He is aware of how crucial it is for professionals of different philosophies of treatment to collaborate and co-manage patients for the best possible outcome.`, `Dr. Dante was born and raised in New York, where he also holds a board certification and is licensed to practice. Dr. Dante is entirely committed to his career in chiropractic and wellness, and  he eagerly awaits the chance to help you on your road to health and wellness.`, `He currently resides in Marietta, Georgia, together with his wife and kids. When he’s not working or  publicly speaking to his community, you can find him enjoying time with his family.`],
