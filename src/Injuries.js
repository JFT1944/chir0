...
let data = [
    ...
    We utilize a wide variety of treatment techniques to provide the best quality services to our patients. 
    Below are the accident injuries and pain symptoms that our chiropractors specialize in treating at Pro Healthcare Rehab.`]},
    ...
    {title2:`Sports Injuries`, text:[`Sports Injuries can be caused by an acute trauma, or repetitive stress. Regardless of how your condition was caused, our office can help treat your injury, reduce your pain, and help you regain full function in the injured area.`]},
    ...
    {title2:`Slip and Fall Injury`, text:[`Slip and fall injuries can be caused by negligence or by chance.  Your ligaments, bones, muscles, and joints can all be affected by a slip and fall. The spine is particularly prone to injury, as people tend to fall backward. When you land on your back, the joints that connect your spinal column can drop and the joint will swell. This causes muscle spasms and sever back pain…all of which impair everyday living.`]},
    ...
    {title2:`Migraines and Headaches`, text:[`Migraines and headaches can be a symptom of any type of accident or injury. If you are suffering from subluxation in the spine, it can negatively affect other areas of the body, causing headaches and pains. Your chiropractor can properly realign your spine and treat these symptoms with adjustments.`]},
    {title2:`Nerve Damage`, text:[`Nerve damage is usually caused by a compressed or slipped disc in the spinal column. This condition is caused by traumas, like car accidents, or can result just from a physical lifestyle. Chiropractors can help treat this condition and reduce pain while preventing the need for surgery.`]},
]
